...
- [openebs/.github](https://github.com/openebs/.github) - Top level project User Experience repo (1 day ago)
...
- [VictoriaMetrics/helm-charts](https://github.com/VictoriaMetrics/helm-charts) ([victoria-metrics-k8s-stack-0.55.2](https://github.com/VictoriaMetrics/helm-charts/releases/tag/victoria-metrics-k8s-stack-0.55.2), 5 days ago) - Helm charts for VictoriaMetrics, VictoriaLogs and ecosystem 
...
- [unovue/shadcn-vue](https://github.com/unovue/shadcn-vue) - Vue port of shadcn-ui (1 day ago)
- [google/go-licenses](https://github.com/google/go-licenses) - A lightweight tool to report on the licenses used by a Go package and its dependencies. Highlight! Versioned external URL to licenses can be found at the same time. (3 days ago)
- [ThePrimeagen/anime](https://github.com/ThePrimeagen/anime) - The repo that everyone deserves (3 days ago)
- [Delgan/loguru](https://github.com/Delgan/loguru) - Python logging made (stupidly) simple (3 days ago)
- [CrazyTim/spin-wheel](https://github.com/CrazyTim/spin-wheel) - An easy to use, themeable component for randomising choices and prizes. (3 days ago)
- [astral-sh/rye](https://github.com/astral-sh/rye) - a Hassle-Free Python Experience (4 days ago)
- [B16f00t/whapa](https://github.com/B16f00t/whapa) - WhatsApp Parser Toolset v1.59 (4 days ago)
