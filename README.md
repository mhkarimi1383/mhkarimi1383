...
- [VictoriaMetrics/helm-charts](https://github.com/VictoriaMetrics/helm-charts) ([victoria-metrics-single-0.19.1](https://github.com/VictoriaMetrics/helm-charts/releases/tag/victoria-metrics-single-0.19.1), 1 day ago) - Helm charts for VictoriaMetrics, VictoriaLogs and ecosystem 
...
- [:memo: Fix OpenSSF link and Add pre-commit.ci badge](https://github.com/openebs/rawfile-localpv/pull/85) on [openebs/rawfile-localpv](https://github.com/openebs/rawfile-localpv) (3 weeks ago)
...
- [im-samir-dev/tbot-barq](https://github.com/im-samir-dev/tbot-barq) - A sample Telegram bot to get data from an external server and send to users (2 days ago)
...
- [mozilla-firefox/firefox](https://github.com/mozilla-firefox/firefox) - The official repository of Mozilla&#39;s Firefox web browser. (3 days ago)
- [pulp/pulp_ansible](https://github.com/pulp/pulp_ansible) - A Pulp plugin that manages Ansible content, i.e. roles, collections (4 days ago)
- [ansible/galaxy_ng](https://github.com/ansible/galaxy_ng) - Ansible Galaxy Server - Issues on https://forum.ansible.com Docs on https://galaxy-ng.readthedocs.io/ (4 days ago)
- [ponyorm/pony](https://github.com/ponyorm/pony) - Pony Object Relational Mapper (5 days ago)
- [immunant/c2rust](https://github.com/immunant/c2rust) - Migrate C code to Rust (6 days ago)
- [colored-rs/colored](https://github.com/colored-rs/colored) - (Rust) Coloring terminal so simple you already know how to do it ! (6 days ago)
