...
- [openebs/community](https://github.com/openebs/community) - OpenEBS community resources (today)
...
- [openebs/.github](https://github.com/openebs/.github) - Top level project User Experience repo (2 weeks ago)
...
- [VictoriaMetrics/helm-charts](https://github.com/VictoriaMetrics/helm-charts) ([victoria-metrics-operator-0.51.2](https://github.com/VictoriaMetrics/helm-charts/releases/tag/victoria-metrics-operator-0.51.2), 2 days ago) - Helm charts for VictoriaMetrics, VictoriaLogs and ecosystem 
- [openebs/rawfile-localpv](https://github.com/openebs/rawfile-localpv) ([v0.10.0](https://github.com/openebs/rawfile-localpv/releases/tag/v0.10.0), 1 month ago) - Dynamically deploy Stateful Persistent Node-Local Volumes &amp; Filesystems for Kubernetes that is provisioned from RAW-device file loop mounted Local-Hostpath storage.
...
- [minio/minio-py](https://github.com/minio/minio-py) ([7.2.15](https://github.com/minio/minio-py/releases/tag/7.2.15), 6 months ago) - MinIO Client SDK for Python
- [ParminCloud/arvancloud-certmanager-issuer](https://github.com/ParminCloud/arvancloud-certmanager-issuer) ([chart-0.0.13](https://github.com/ParminCloud/arvancloud-certmanager-issuer/releases/tag/chart-0.0.13), 7 months ago) - A cert-manager ACME DNS01 solver webhook for ArvanCloud
...
- [:zap: Improve volume verifier and task pod to be more safe](https://github.com/openebs/rawfile-localpv/pull/173) on [openebs/rawfile-localpv](https://github.com/openebs/rawfile-localpv) (today)
- [Fix rawfile-localpv repository link](https://github.com/openebs/community/pull/211) on [openebs/community](https://github.com/openebs/community) (1 day ago)
- [:chart_with_upwards_trend: Add GA4 module](https://github.com/openebs/rawfile-localpv/pull/172) on [openebs/rawfile-localpv](https://github.com/openebs/rawfile-localpv) (2 days ago)
- [:arrow_up: Upgrade go version](https://github.com/ParminCloud/arvancloud-certmanager-issuer/pull/111) on [ParminCloud/arvancloud-certmanager-issuer](https://github.com/ParminCloud/arvancloud-certmanager-issuer) (3 days ago)
- [:sparkles: Add format options support](https://github.com/openebs/rawfile-localpv/pull/168) on [openebs/rawfile-localpv](https://github.com/openebs/rawfile-localpv) (4 days ago)
- [:construction: Changing CLi System to use pydantic](https://github.com/openebs/rawfile-localpv/pull/166) on [openebs/rawfile-localpv](https://github.com/openebs/rawfile-localpv) (5 days ago)
- [:zap: Tuning gRPC server](https://github.com/openebs/rawfile-localpv/pull/164) on [openebs/rawfile-localpv](https://github.com/openebs/rawfile-localpv) (6 days ago)
...
- [ueberdosis/tiptap](https://github.com/ueberdosis/tiptap) - The headless rich text editor framework for web artisans. (4 days ago)
- [anthropics/claude-code](https://github.com/anthropics/claude-code) - Claude Code is an agentic coding tool that lives in your terminal, understands your codebase, and helps you code faster by executing routine tasks, explaining complex code, and handling git workflows - all through natural language commands. (5 days ago)
- [daviddrysdale/python-phonenumbers](https://github.com/daviddrysdale/python-phonenumbers) - Python port of Google&#39;s libphonenumber (5 days ago)
- [motmaenbash/motmaenbash-firefox](https://github.com/motmaenbash/motmaenbash-firefox) - motmaenbash-firefox (6 days ago)
- [motmaenbash/motmaenbash-android](https://github.com/motmaenbash/motmaenbash-android) - MotmaenBash (6 days ago)
- [fsspec/filesystem_spec](https://github.com/fsspec/filesystem_spec) - A specification that python filesystems should adhere to. (6 days ago)
- [drivendataorg/cloudpathlib](https://github.com/drivendataorg/cloudpathlib) - Python pathlib-style classes for cloud storage services such as Amazon S3, Azure Blob Storage, and Google Cloud Storage. (6 days ago)
- [piskvorky/smart_open](https://github.com/piskvorky/smart_open) - Utils for streaming large files (S3, HDFS, gzip, bz2...) (6 days ago)
- [stewartsmith/libeatmydata](https://github.com/stewartsmith/libeatmydata) - libeatmydata - because fsync() should be a no-op (1 week ago)
- [ilikenwf/apt-fast](https://github.com/ilikenwf/apt-fast) - apt-fast: A shellscript wrapper for apt that speeds up downloading of packages. (1 week ago)

### 👯 Check out some of my recent followers

- [mhmiripoor](https://github.com/mhmiripoor)
- [NarimanTajari](https://github.com/NarimanTajari)
- [korbirayen](https://github.com/korbirayen)
