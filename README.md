...
- [openebs/rawfile-localpv](https://github.com/openebs/rawfile-localpv) ([v0.13.0](https://github.com/openebs/rawfile-localpv/releases/tag/v0.13.0), 2 days ago) - Dynamically deploy Stateful Persistent Node-Local Volumes &amp; Filesystems for Kubernetes that is provisioned from RAW-device file loop mounted Local-Hostpath storage.
