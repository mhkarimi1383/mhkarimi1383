...
- [mhkarimi1383/minecraft-wallpapers](https://github.com/mhkarimi1383/minecraft-wallpapers) - Wallpapers Collected from https://www.minecraft.net/en-us/collectibles?tabs=%7B%22tab%22%3A0%7D to be able to be used as sub-module in dotfiles/configurations and projects  (today)
...
- [VictoriaMetrics/helm-charts](https://github.com/VictoriaMetrics/helm-charts) ([victoria-metrics-operator-crds-0.0.3](https://github.com/VictoriaMetrics/helm-charts/releases/tag/victoria-metrics-operator-crds-0.0.3), today) - Helm charts for VictoriaMetrics, VictoriaLogs and ecosystem 
...
- [NixOS/nixfmt](https://github.com/NixOS/nixfmt) - The official (but not yet stable) formatter for Nix code (today)
- [github/github-mcp-server](https://github.com/github/github-mcp-server) - GitHub&#39;s official MCP Server (1 day ago)
- [zhichaoh/catppuccin-wallpapers](https://github.com/zhichaoh/catppuccin-wallpapers) - 🖼️ Wallpapers to match your Catppuccin setups! (1 day ago)
- [Col-E/Recaf](https://github.com/Col-E/Recaf) - The modern Java bytecode editor (6 days ago)
