...
- [VictoriaMetrics/helm-charts](https://github.com/VictoriaMetrics/helm-charts) ([victoria-metrics-k8s-stack-0.39.4](https://github.com/VictoriaMetrics/helm-charts/releases/tag/victoria-metrics-k8s-stack-0.39.4), today) - Helm charts for VictoriaMetrics, VictoriaLogs and ecosystem 
- [helmwave/helmwave](https://github.com/helmwave/helmwave) ([v0.41.9](https://github.com/helmwave/helmwave/releases/tag/v0.41.9), 6 days ago) - New 🌊 wave for @helm
...
- [DandyDeveloper/charts](https://github.com/DandyDeveloper/charts) ([redis-ha-4.33.4](https://github.com/DandyDeveloper/charts/releases/tag/redis-ha-4.33.4), 4 weeks ago) - Various helm charts migrated from [helm/stable] due to deprecation
...
- [:arrow_up: Upgrade python in pyproject and nix shell](https://github.com/openebs/rawfile-localpv/pull/73) on [openebs/rawfile-localpv](https://github.com/openebs/rawfile-localpv) (1 week ago)
...
- [Remove deprecated --parallel in docker compose pull](https://github.com/openreplay/openreplay/pull/3066) on [openreplay/openreplay](https://github.com/openreplay/openreplay) (4 weeks ago)
...
- [netblue30/firejail](https://github.com/netblue30/firejail) - Linux namespaces and seccomp-bpf sandbox (2 days ago)
- [alainm23/planify](https://github.com/alainm23/planify) - Task manager with Todoist &amp; Nextcloud support designed for GNOME (2 days ago)
- [Zouuup/landrun](https://github.com/Zouuup/landrun) - Run any Linux process in a secure, unprivileged sandbox using Landlock. Think firejail, but lightweight, user-friendly, and baked into the kernel. (3 days ago)
