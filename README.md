...
- [openebs/openebs](https://github.com/openebs/openebs) ([v4.5.1](https://github.com/openebs/openebs/releases/tag/v4.5.1), 6 days ago) - A popular &amp; widely deployed Open Source Container Native Storage platform for Stateful Persistent Applications on Kubernetes.
...
- [redis/fastapi-redis-sdk](https://github.com/redis/fastapi-redis-sdk) - FastAPI SDK for Redis (today)
